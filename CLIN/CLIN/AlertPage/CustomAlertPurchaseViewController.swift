//
//  CustomAlertPurchaseViewController.swift
//  CLIN
//
...
class CustomAlertPurchaseViewController: UIViewController {
    ...
    @IBAction func touchOKButton(_ sender: UIButton) {
        ...
        let vcName = storyboard?.instantiateViewController(withIdentifier: "CustomAlertHappyViewController")
